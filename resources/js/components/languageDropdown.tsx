    ...
    return (
        <div className="relative flex flex-col items-center">
            <button
                ...
                className="relative flex flex-row gap-0.5 text-[14px] font-bold text-netural-1000 items-center justify-center min-w-[95px] h-[44px] rounded-full border-[1px] border-orange-500"
            >
                {currentLanguage === 'ar' ? (
